...
const Footer = () => {
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8  md:text-left">
          ...
          <div>
            <h3 className="text-xl font-semibold text-white mb-4">About Us</h3>
            <p className="text-sm">
              INU Choose International Education is a UK-based scholarship initiative designed to empower Indian students to pursue higher education in the UK. 
              With transparent selection processes and limited slots, we aim to give deserving students a chance to study without financial burdens.
            </p>
          </div>
          ...
          <div className="text-center md:text-left">
            <h3 className="text-xl font-semibold text-white mb-4 ">Contact</h3>
            <p>Email: support@inuchoose.com</p>
            <p>Phone: +91 999999999</p>
            <p>Address: Hyderabad, India</p>
          </div>
        </div>
  ...
  shadow-md hover:shadow-lg border-[2px] border-black transition-all duration-300 transform hover:scale-105"
        ...
        {/* Bottom Section */}
        <div className="border-t border-gray-700 mt-6 pt-4 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} INU Choose. All Rights Reserved.</p>
        </div>
      </div>
      <div>
        <p className="text-center text-sm text-gray-600">
