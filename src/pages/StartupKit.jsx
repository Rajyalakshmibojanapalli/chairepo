      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold font-playfair text-[#8dcb3f]">Premium Benefits</h2>
            <div className="h-1 w-20 bg-amber-500 mx-auto mt-4 mb-2 rounded-full"></div>
            <p className="text-[#8dcb3f] text-lg max-w-2xl mx-auto">
          ...
          >
            {franchiseBenefits.map((benefit, index) => (
              <motion.div
                key={index}
                variants={cardVariants}
                whileHover={{ y: -10, boxShadow: '0 10px 25px -5px #8dcb3f' }}
              ...
              >
                <h3 className="text-xl font-bold text-[#8dcb3f] mb-3">{benefit.title}</h3>
                <p className="text-[#8dcb3f]">{benefit.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </motion.div>
