...
>
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="flex justify-center lg:justify-end">
      ...
      {/* Gallery Section */}
<section ref={galleryRef} className="py-16 sm:py-24  relative overflow-hidden" id="gallery">
...
<section ref={reviewRef} className="py-20 md:py-28 relative overflow-hidden">
    ...
    >
        ...
        <div className="relative h-[400px] md:h-[500px]">
          ...
          <motion.div
            ...
            variants={{
              ...
              visible: { opacity: 1, scale: 1, rotate: -5, transition: { duration: 0.6, delay: 0.7 } },
            }}
          >
      ...
      >
        ...
        >
          ...
          <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">Customer Reviews</h3>
        </motion.div>
        ...
        <Swiper 
          ...
          pagination={{
            ...
            bulletClass: "inline-block w-3 h-3 rounded-full bg-white/30 mx-1 transition-all duration-300"
          }}
          spaceBetween={30}
          ...
          {[
            ...
            <SwiperSlide key={index} className="pb-12">
              ...
              >
                ...
                {/* Quote icon */}
                <svg className="w-10 h-10 text-[#8dcb3f]/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
