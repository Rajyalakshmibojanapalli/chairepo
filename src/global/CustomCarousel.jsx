...
const CustomCarouselContext = createContext({
  onCardClose: () => {},
  currentIndex: 0,
});
...
const CustomCarousel = ({ cards = [], initialScroll = 0 }) => {
  ...
  const Card = ({ card, index, layout = false }) => {
    ...
    // Custom Blur Image Component (internal)
    const BlurImage = ({
      height,
      width,
      src,
      ...
      return (
        <Image
          className={combineClasses("transition duration-300", isLoading ? "blur-sm" : "blur-0", className)}
